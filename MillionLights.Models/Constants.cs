   ...
   public class Constants
    {
       ...
       public const string UserRegMsgNotification = "Your registration with MillionLights is successful. Your login id {0} and Password is {1}";
       public const string StudentRegMsgNotification = "Your registration with MillionLights is successful. Your login id {0}";
       public const string ExtUserRegMsgNotification = "Your registration with MillionLights is successful. Your login id {0}";
       public const string ForgotPwdSubNotification = "Your password reset request has been sent to you successfully.";
       public const string ForgotPwdMsgNotification = "Please note, a link to reset your password has been sent to you.In case of any issues, contact MillionLights Support at support@millionlights.org ";
       public const string ResetPwdSubNotification = "Your Password reset successfully";
       public const string ResetPwdMsgNotification = "Please note, your password has been reset as requested by you.In case of any issues, contact MillionLights Support at support@millionlights.org";
       ...
       public const string UserRegistrationSuccessMsg = "Your Millionlights registration is successful. Loginid is {0} and Password is {1}";
       public const string StudentRegistrationSuccessMsg = "Your Millionlights registration is successful. Loginid is {0}";
       public const string UserPasswordChange = "Your MillionLights password has been changed successfully. Your LoginId is {0}";
       ...
       public const string OrderFailSMSMsg = "Your order {0} on Millionlights has failed.";
       public const string OrderSuccessSMSMsg = "Your order {0} on Millionlights is successful";
       public const string ContactUsSMSMsg = "Thank you for contacting Millionlights. We will get back to you soon.";
       ...
       public static Dictionary<string, string> Messages()
       {
           ...
           messages.Add("CouponInvalid", "The Coupon you entered has been already redeemed. You can verify the coupon status in My Account or Contact us at Support@millionlights.org .");
